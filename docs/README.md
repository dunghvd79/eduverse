# 📂 Tài liệu Thiết kế — EduVerse

> Toàn bộ tài liệu được quản lý theo phương pháp **Docs-as-Code** (Markdown + Mermaid, version control bằng Git).

## Mục lục

### 📋 Phân tích Yêu cầu
- [Đặc tả yêu cầu phần mềm (SRS)](requirements/srs.md)
- [Quy tắc nghiệp vụ](requirements/business-rules.md)
...
### 🔄 Sequence Diagrams
- [Luồng đăng nhập](sequences/seq-login.md)
- [Luồng ghi danh](sequences/seq-enroll.md)
- [Luồng làm bài kiểm tra](sequences/seq-quiz.md)
- [Luồng nộp bài tập](sequences/seq-submit.md)
